...
myrole:
title: Six golden rules of crowdsourcing in digital humanities
blurb: These are the lessons I’ve learned from building crowdsourcing websites.
preview: illustration.jpg
---

# Six golden rules of crowdsourcing in digital humanities

These are the lessons I’ve learned from building crowdsourcing websites. {.lead}

![](illustration.jpg)

(This article is based on my talk ‘An tras-scríobh sluafhoinsithe: sa tóir ar an oideas ceart’ \[Crowdsourced transcription: looking for the right recipe\] which I gave in May 2026 in Dublin at a conference on Irish-language digital humanities *(Comhdháil ar na Daonnachtaí Digiteacha sa Ghaeilge)* organised by Dublin City University’s [Fiontar & Scoil na Gaeilge](https://www.dcu.ie/fiontarscoilnagaeilge) and University of Notre Dame’s [Keough-Naughton Institute for Irish Studies](https://irishstudies.nd.edu/).) {.meta}
...
**Example 1.** The first is [Dúchas.ie](https://www.duchas.ie/), a website where you can browse digitised content from Ireland’s National Folklore Collection. Much of the content is scanned pages of handwritten text. There is a feature on the website where, if you see a scanned page that hasn’t been transcribed yet, you can open up a textbox, transcribe it yourself, and click a button to submit your transcription.

![A scanned pages of handwritten text on Dúchas.ie with an empty text box on the side.](pic1.png)
...
## Rule 1: Have a sense of purpose
...
On Fosgladh an Tobair we went further and created a [leaderboard-style](https://fosgladh.tobarandualchais.co.uk/en/u) page where you can see who the most active contributors are. This introduces an aspect of competitiveness into the system, which is a game you need to play carefully: you don’t want to pitch the volunteers against one another, do you? Any hint of competition needs to be good-natured and not too in-your-face. In the end, crowdsourcing is about people coming together for a shared purpose, your job as a website builder is to encourage that to happen.
